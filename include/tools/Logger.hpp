...
public:
    ...
    public:
        // 构造函数
        LogStream(Logger& logger, LogLevel level, const char* file, const char* func, int line)
...
private:
    Logger() : logLevel_(LogLevel::INFO) { }  // 默认INFO级别
...
// 日志宏定义
#if LOG_ENABLED
    #define LOG_INFO()  Logger::LogStream(Logger::instance(), LogLevel::INFO , __FILE__, __FUNCTION__, __LINE__)
    #define LOG_DEBUG() Logger::LogStream(Logger::instance(), LogLevel::DEBUG, __FILE__, __FUNCTION__, __LINE__)
    #define LOG_WARN()  Logger::LogStream(Logger::instance(), LogLevel::WARN , __FILE__, __FUNCTION__, __LINE__)
    #define LOG_ERROR() Logger::LogStream(Logger::instance(), LogLevel::ERROR, __FILE__, __FUNCTION__, __LINE__)
    #define LOG_FATAL() Logger::LogStream(Logger::instance(), LogLevel::FATAL, __FILE__, __FUNCTION__, __LINE__)
#else
